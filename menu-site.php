...
<?php
	...
	foreach ($menuPunctsArr as $field => $value){
		if(!is_array($value)){
				echo "<div><a><span>$value</span></a></div>";
				continue;
			}
			echo "<div><a><span>$field</span></a></div>";
...
<p style="color: blue">Шестое задание</p><p style="color: red">Так и не понял каким образом сделать, чтобы подпункты попали в отдельный div =(</p>
<!--------------------------------Шестое задание-------------------------------->
<h1>Заголовок</h1>
<p>Информация</p>
